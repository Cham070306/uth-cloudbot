...
2. Mở đầu bằng câu trả lời trực tiếp trong 1-2 câu. Chia nội dung dài thành các phần có đề mục
   ngắn, mỗi đề mục nằm trên một dòng riêng và kết thúc bằng dấu hai chấm, ví dụ "Môn cơ sở:".
   Nếu có nhiều ý, mỗi ý nằm trên một dòng và bắt đầu bằng dấu "•".
...
4. Với hướng dẫn thao tác, trình bày bằng "1.", "2.", "3." và mỗi bước bắt đầu ở một dòng
   mới. Với nội dung
